...
def test_canary_behaviours(monkeypatch):
    ...
    with pytest.MonkeyPatch.context() as mp:
        test_canary_detects_broken_verifier(mp)
    with pytest.MonkeyPatch.context() as mp:
        test_canary_passes_when_all_verifiers_reject(mp)
    with pytest.MonkeyPatch.context() as mp:
        test_canary_exits_1_when_all_tasks_skipped(mp)
