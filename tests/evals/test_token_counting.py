...
def test_agent_behaviours(monkeypatch):
    ...
    with pytest.MonkeyPatch.context() as mp:
        test_agent_run_payload_uses_importable_tokenizer(mp)
    with pytest.MonkeyPatch.context() as mp:
        test_agent_run_payload_falls_back_to_shared_estimator_without_tokenizer(mp)
