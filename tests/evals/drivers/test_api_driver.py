...
def test_api_driver_behaviours():
    ...
    test_api_driver_multi_turn_tool_loop_and_usage_accumulation()
    test_api_driver_refusal_records_calls_but_executes_nothing()
    test_api_driver_pairs_results_by_id_not_ordinal()
    test_api_driver_flags_result_id_mismatch()
    test_api_driver_iteration_cap_only_flags_mid_tool_loop()
...
def test_openai_backend_behaviours():
    ...
    test_openai_backend_translates_tools_calls_and_tool_messages()
    test_openai_backend_normalizes_refusal_for_driver_guard()
...
def test_tool_behaviours():
    ...
    def test_tool_result_behaviours():
        ...
        test_tool_result_from_mcp_text_only_joins_blocks()
        test_tool_result_from_mcp_serializes_non_text_blocks()
        test_tool_result_from_mcp_propagates_error_flag_in_both_spellings()

    test_tool_spec_from_mcp_reads_dict_and_object_entries()
    test_tool_result_behaviours()
