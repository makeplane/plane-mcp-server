...
export const Cycle = z.object({
  ...
  created_by: z.string().uuid().nullable().readonly(),
  deleted_at: z.string().datetime({ offset: true }).nullable().readonly(),
  description: z.string().optional(),
  end_date: z.string().date().nullable().optional().describe("The end date of the cycle of format YYYY-MM-DD"),
  external_id: z.string().max(255).nullable().optional(),
  external_source: z.string().max(255).nullable().optional(),
  ...
  start_date: z.string().date().nullable().optional().describe("The start date of the cycle of format YYYY-MM-DD"),
  ...
  updated_by: z.string().uuid().nullable().readonly(),
...
export const Issue = z.object({
  archived_at: z.string().date().nullable().optional(),
  assignees: z.array(z.string().uuid()).optional(),
  completed_at: z.string().datetime({ offset: true }).nullable().optional(),
  created_at: z.string().datetime({ offset: true }).readonly(),
  created_by: z.string().uuid().nullable().optional(),
  deleted_at: z.string().datetime({ offset: true }).nullable().optional(),
  description_binary: z.string().nullable().readonly(),
  description_html: z.string().optional(),
  estimate_point: z.string().uuid().nullable().optional(),
  external_id: z.string().max(255).nullable().optional(),
  external_source: z.string().max(255).nullable().optional(),
  id: z.string().uuid().readonly(),
  ...
  point: z.number().int().gte(0).lte(12).nullable().optional(),
...
export const Module = z.object({
  ...
  deleted_at: z.string().datetime({ offset: true }).nullable().readonly(),
  description: z.string().optional(),
  description_html: z.any().nullable().optional(),
  description_text: z.any().nullable().optional(),
  external_id: z.string().max(255).nullable().optional(),
  external_source: z.string().max(255).nullable().optional(),
  id: z.string().uuid().readonly(),
  lead: z.string().uuid().nullable().optional(),
  logo_props: z.any().optional(),
...
export const Project = z.object({
  ...
  cover_image_asset: z.string().uuid().nullable().optional(),
