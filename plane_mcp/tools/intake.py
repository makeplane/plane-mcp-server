...
def register_intake_tools(mcp: FastMCP) -> None:
    ...
    def retrieve_intake_work_item(
        ...
        """Retrieve an intake work item by work item ID (use the issue field, not the intake work item ID)."""
        client, workspace_slug = get_plane_client_context()
    ...
    def update_intake_work_item(
        ...
        """Update an intake work item by work item ID (use the issue field, not the intake work item ID)."""
        client, workspace_slug = get_plane_client_context()
    ...
    def delete_intake_work_item(project_id: str, work_item_id: str) -> None:
        """Delete an intake work item by work item ID (use the issue field, not the intake work item ID)."""
        client, workspace_slug = get_plane_client_context()
